<x-guest-layout>
    ...
    <section class="w-full p-6 flex flex-col gap-4">
        ...
        bg-gray-200 dark:bg-gray-800">
            ...
            <p class="p-2 w-5/6 dark:text-gray-200">{{$wordType->name}}</p>
        </div>
        ...
        bg-gray-200 dark:bg-gray-800">
            ...
            <p class="p-2 w-5/6 dark:text-gray-200">{{$wordType->code}}</p>
        </div>
        ...
        bg-gray-200 dark:bg-gray-800">
            ...
            <p class="p-2 w-5/6 dark:text-gray-200">{{$wordType->created_at}}</p>
        ...
        bg-gray-200 dark:bg-gray-800">
            ...
            <p class="p-2 w-5/6 dark:text-gray-200" >{{$wordType->updated_at}}</p>
        </div>
